...
const ProjectMain = (props) => {
  return (
    <main className=' h-fit w-full absolute bg-accent px-2 lg:px-4 xl:px-6 mt-2 text-white'>
      ...
      <section className='projectHero m-4'>
        <div className='border-b-2 py-2 pb-0 border-white text-4xl'>
          ...
          <div className='py-4 text-lg lg:text-xl'>
            <Link className='underline hover:text-primary' href={props.href}>Click here to view website</Link>
        </div>
        </div> 
