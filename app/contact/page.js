        ...
        <div className='contactContainer relative z-30  text-center'>
          ...
          <div>
            <ul className='text-2xl 2xl:text-4xl pt-2'>
              <li  className='py-4'>
                Email: <Link id='contactEmail' href={'mailto:jeremy.sluder@gmail.com'} target='_blank' type='email' className={`btn-link  font-bold hover:text-gray-50 ${styles.email}`}>Jeremy.Sluder@gmail.com</Link>
              </li>
              <li id='contactLinked' className='py-4'>
                <Link href={'https://www.linkedin.com/in/jeremy-sluder-0077b099/'} target='_blank' className='btn-link  font-bold hover:text-gray-50 '>LinkedIn</Link>
              </li>
              <li id='contactGit' className='py-4'>
                <Link href={'https://github.com/jcodes89'} target='_blank' className='btn-link font-bold hover:text-gray-50' >Github</Link>
              </li>
            </ul>
          </div>
        </div>
